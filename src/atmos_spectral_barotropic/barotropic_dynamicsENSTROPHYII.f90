...
! Enstrophy
enstrophy=>NULL(), enstrophy_tend=>NULL(), enstrophy_pvor_advec=>NULL(), enstrophy_rvormean_advec=>NULL(), enstrophy_rvorprime_advec=>NULL(), enstrophy_trunc=>NULL(), enstrophy_lindamp_m=>NULL(), &
enstrophy_lindamp_e=>NULL(), enstrophy_specdamp=>NULL(), enstrophy_stir=>NULL(), enstrophy_robdamp=>NULL(), &
! Joe variables
