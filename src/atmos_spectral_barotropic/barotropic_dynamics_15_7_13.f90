...
beta_star=>NULL(), tester=>NULL(), vormean_x=>NULL(), vormean_y=>NULL(), vormean_y_tend=>NULL(), vor_y=>NULL(), vor_x=>NULL(), fourier_u=>NULL(), vorprime_prev=>NULL(), vorprime=>NULL(), vork=>NULL(), vork_prev=>NULL(), &
vork_curr=>NULL(), vortendk=>NULL(),  &
! Energy
...
real,    dimension(is:ie, js:je)  :: dt_vorg, stir, uprime, vormean, vorprime, energyprev, energymean_prev, fourier_enstrophy_prev
...
complex, dimension(is:ie+1, js:je):: uk, vk, vork, vork_curr, vork_prev, vortendk, enstrophy_tendk, vbetak, vdy_vormeank, enstrophy_pvor_adveck, enstrophy_rvormean_adveck, vortrunck, vorlindamp_ek, vorlindamp_mk, vorspecdampk, vorrobdampk, vorstirk, vor_xk, vor_yk, vor_xkII, dvork, vor_ykII, enstrophy_trunck, enstrophy_lindamp_ek, enstrophy_lindamp_mk, enstrophy_specdampk, enstrophy_robdampk, enstrophy_stirk, triple_eddy_sumpq
...
! SPECTRAL VORTICTY
!print *, "VOR_TEND = -VORFLUX - 3xEddy - ENSTRUNC", vorf_tend(7,47)*ie/2 + sum(sum(I_vor,2),1) - enstrophy_truncf(7,47)*ie + enstrophy_stirf(7,47)*ie
! SPECTRAL ENSTROPHY
