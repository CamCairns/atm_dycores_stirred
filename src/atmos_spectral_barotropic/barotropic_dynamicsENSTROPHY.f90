...
Dyn%Grid%enstrophy_pvor_advec(:,:,future) = pvor_advecprime*(vorprimeprev+vorprime)
!print *, "ENSTROPHY_PVORADVEC", Dyn%Grid%enstrophy_pvor_advec(22,47,future)
Dyn%Grid%enstrophy_rvor_advec(:,:,future) = rvor_advecprime*(vorprimeprev+vorprime)
!print *, "ENSTROPHY_RVORADVEC", Dyn%Grid%enstrophy_rvor_advec(22,47,future)
Dyn%Grid%enstrophy_rvorprime_advec(:,:,future) = rvor_advecprime*(vorprimeprev+vorprime)
!print *, "ENSTROPHY_RVORADVEC", Dyn%Grid%enstrophy_rvor_advec(22,47,future)
Dyn%Grid%enstrophy_trunc(:,:,future) = vortruncprime*(vorprimeprev+vorprime)
!print *, "ENSTROPHY_TRUNC", Dyn%Grid%enstrophy_trunc(22,47,future)
Dyn%Grid%enstrophy_lindamp_m(:,:,future) = vorlindamp_mprime*(vorprimeprev+vorprime)
!print *, "ENSTROPHY_LINDAMP_M", Dyn%Grid%enstrophy_lindamp_m(22,47,future)
Dyn%Grid%enstrophy_lindamp_e(:,:,future) = vorlindamp_eprime*(vorprimeprev+vorprime)
!print *, "ENSTROPHY_LINDAMP_E", Dyn%Grid%enstrophy_lindamp_e(22,47,future)
Dyn%Grid%enstrophy_specdamp(:,:,future) = vorspecdampprime*(vorprimeprev+vorprime)
!print *, "ENSTROPHY_SPECDAMP", Dyn%Grid%enstrophy_specdamp(22,47,future)
Dyn%Grid%enstrophy_stir(:,:,future) = vorstirprime*(vorprimeprev+vorprime)
!print *, "ENSTROPHY_STIR", Dyn%Grid%enstrophy_stir(22,47,future)
Dyn%Grid%enstrophy_robdamp(:,:,future) = vorrobdampprime*(vorprimeprev+vorprime)
