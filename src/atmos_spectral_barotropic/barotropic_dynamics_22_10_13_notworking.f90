...
real, POINTER, DIMENSION(:,:,:) :: I1, I2, I3, I4 
...
complex, dimension(is:ie+1, js:je):: uk, vk, v_yk, vork, vork_curr, vork_prev, vorprimetendk, vorprimek, vorprimek_curr, vorprimek_prev, pvor_adveck, rvormean_adveck, enstrophy_pvor_adveck, & 
...
complex, dimension(is:ie, is:ie, is:ie, js:je) :: enstrophy_rvorprime_adveck, tester, tester2, tester3
