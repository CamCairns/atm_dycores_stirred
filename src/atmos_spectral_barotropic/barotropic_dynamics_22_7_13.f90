...
beta_star=>NULL(), tester=>NULL(), tester2=>NULL(), tester3=>NULL(), vormean_x=>NULL(), vormean_y=>NULL(), vorprime_x=>NULL(), vorprime_y=>NULL(), vormean_y_tend=>NULL(), vor_y=>NULL(), vor_x=>NULL(), &
 fourier_u=>NULL(), vorprime_prev=>NULL(), vorprime=>NULL(), vork=>NULL(), vork_prev=>NULL(), vork_curr=>NULL(), vortendk=>NULL(), &
! Some more variables
...
vorprimetend = (vorprime-vorprime_curr)/delta_t
...
vorprimetend = (vorprime-vorprime_prev)/delta_t
...
Dyn%Grid%enstrophy_tend(:,:,future) = 0.5*vorprimetend*(vorprime_prev+vorprime)
...
vorprimetendk(1:ie/2,:) = fft_grid_to_fourier(vorprimetend(:,:))
