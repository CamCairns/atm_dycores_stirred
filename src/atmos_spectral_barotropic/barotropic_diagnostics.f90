...
if(id_u_dvordx > 0) used = send_data(id_u_dvordx , Grid%u_dvordx(:,:,time_index) , time)
if(id_v_dvordy > 0) used = send_data(id_v_dvordy , Grid%v_dvordy(:,:,time_index) , time)
if(id_vor_dudx > 0) used = send_data(id_u_dvordx , Grid%vor_dudx(:,:,time_index) , time)
if(id_vor_dvdy > 0) used = send_data(id_u_dvordx , Grid%vor_dvdy(:,:,time_index) , time)
! ENERGY TERMS
