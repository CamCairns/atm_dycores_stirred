...
beta_star=>NULL(), tester=>NULL(), vormean_x=>NULL(), vormean_y=>NULL(), vorprime_x=>NULL(), vorprime_y=>NULL(), vormean_y_tend=>NULL(), vor_y=>NULL(), vor_x=>NULL(), & 
...
vortendk=>NULL(), vormeantend=>NULL(), vorprimetend=>NULL(), XX=>NULL(), &
! Some more variables
uprev=>NULL(), ucurr=>NULL(), vprev=>NULL(), vcurr=>NULL(), vorprev=>NULL(), vorcurr=>NULL(), &
! Energy
...
! Enstrophy
enstrophy=>NULL(), enstrophy_tend=>NULL(), enstrophy_dt_vor=>NULL(), enstrophy_pvor_advec=>NULL(), enstrophy_rvormean_advec=>NULL(), enstrophy_rvorprime_advec=>NULL(), enstrophy_trunc=>NULL(), enstrophy_lindamp_m=>NULL(), enstrophy_lindamp_e=>NULL(), enstrophy_specdamp=>NULL(), enstrophy_stir=>NULL(), enstrophy_robdamp=>NULL(), &
...
enstrophy_robdampk=>NULL(), enstrophy_stirk=>NULL(), enstrophy_rvorprime_adveck_SUM=>NULL(), &
! Joe variables
...
! Flux Variables
I_p01_q01=>NULL(),	I_p01_q02=>NULL(),	I_p01_q03=>NULL(),	I_p01_q04=>NULL(),	I_p01_q05=>NULL(),	I_p01_q06=>NULL(),	I_p01_q07=>NULL(),	I_p01_q08=>NULL(), &	I_p01_q09=>NULL(),	I_p01_q10=>NULL(),	I_p01_q11=>NULL(),	I_p01_q12=>NULL(), &
I_p02_q01=>NULL(),	I_p02_q02=>NULL(),	I_p02_q03=>NULL(),	I_p02_q04=>NULL(),	I_p02_q05=>NULL(),	I_p02_q06=>NULL(),	I_p02_q07=>NULL(),	I_p02_q08=>NULL(), &	I_p02_q09=>NULL(),	I_p02_q10=>NULL(),	I_p02_q11=>NULL(),	I_p02_q12=>NULL(), &
I_p03_q01=>NULL(),	I_p03_q02=>NULL(),	I_p03_q03=>NULL(),	I_p03_q04=>NULL(),	I_p03_q05=>NULL(),	I_p03_q06=>NULL(),	I_p03_q07=>NULL(),	I_p03_q08=>NULL(), &	I_p03_q09=>NULL(),	I_p03_q10=>NULL(),	I_p03_q11=>NULL(),	I_p03_q12=>NULL(), &
I_p04_q01=>NULL(),	I_p04_q02=>NULL(),	I_p04_q03=>NULL(),	I_p04_q04=>NULL(),	I_p04_q05=>NULL(),	I_p04_q06=>NULL(),	I_p04_q07=>NULL(),	I_p04_q08=>NULL(), &	I_p04_q09=>NULL(),	I_p04_q10=>NULL(),	I_p04_q11=>NULL(),	I_p04_q12=>NULL(), &
I_p05_q01=>NULL(),	I_p05_q02=>NULL(),	I_p05_q03=>NULL(),	I_p05_q04=>NULL(),	I_p05_q05=>NULL(),	I_p05_q06=>NULL(),	I_p05_q07=>NULL(),	I_p05_q08=>NULL(), &	I_p05_q09=>NULL(),	I_p05_q10=>NULL(),	I_p05_q11=>NULL(),	I_p05_q12=>NULL(), &
I_p06_q01=>NULL(),	I_p06_q02=>NULL(),	I_p06_q03=>NULL(),	I_p06_q04=>NULL(),	I_p06_q05=>NULL(),	I_p06_q06=>NULL(),	I_p06_q07=>NULL(),	I_p06_q08=>NULL(), &	I_p06_q09=>NULL(),	I_p06_q10=>NULL(),	I_p06_q11=>NULL(),	I_p06_q12=>NULL(), &
I_p07_q01=>NULL(),	I_p07_q02=>NULL(),	I_p07_q03=>NULL(),	I_p07_q04=>NULL(),	I_p07_q05=>NULL(),	I_p07_q06=>NULL(),	I_p07_q07=>NULL(),	I_p07_q08=>NULL(), &	I_p07_q09=>NULL(),	I_p07_q10=>NULL(),	I_p07_q11=>NULL(),	I_p07_q12=>NULL(), &
I_p08_q01=>NULL(),	I_p08_q02=>NULL(),	I_p08_q03=>NULL(),	I_p08_q04=>NULL(),	I_p08_q05=>NULL(),	I_p08_q06=>NULL(),	I_p08_q07=>NULL(),	I_p08_q08=>NULL(), &	I_p08_q09=>NULL(),	I_p08_q10=>NULL(),	I_p08_q11=>NULL(),	I_p08_q12=>NULL(), &
I_p09_q01=>NULL(),	I_p09_q02=>NULL(),	I_p09_q03=>NULL(),	I_p09_q04=>NULL(),	I_p09_q05=>NULL(),	I_p09_q06=>NULL(),	I_p09_q07=>NULL(),	I_p09_q08=>NULL(), &	I_p09_q09=>NULL(),	I_p09_q10=>NULL(),	I_p09_q11=>NULL(),	I_p09_q12=>NULL(), &
I_p10_q01=>NULL(),	I_p10_q02=>NULL(),	I_p10_q03=>NULL(),	I_p10_q04=>NULL(),	I_p10_q05=>NULL(),	I_p10_q06=>NULL(),	I_p10_q07=>NULL(),	I_p10_q08=>NULL(), &	I_p10_q09=>NULL(),	I_p10_q10=>NULL(),	I_p10_q11=>NULL(),	I_p10_q12=>NULL(), &
I_p11_q01=>NULL(),	I_p11_q02=>NULL(),	I_p11_q03=>NULL(),	I_p11_q04=>NULL(),	I_p11_q05=>NULL(),	I_p11_q06=>NULL(),	I_p11_q07=>NULL(),	I_p11_q08=>NULL(), &	
I_p11_q09=>NULL(),	I_p11_q10=>NULL(),	I_p11_q11=>NULL(),	I_p11_q12=>NULL(), &
I_p12_q01=>NULL(),	I_p12_q02=>NULL(),	I_p12_q03=>NULL(),	I_p12_q04=>NULL(), 	I_p12_q05=>NULL(),	I_p12_q06=>NULL(),	I_p12_q07=>NULL(),	I_p12_q08=>NULL(), &
I_p12_q09=>NULL(),	I_p12_q10=>NULL(),	I_p12_q11=>NULL(),	I_p12_q12=>NULL()
...
type testing_type
   real, pointer, dimension(:,:,:,:) :: f_test=>NULL(), enstrophy_rvorprime_adveck=>NULL()
end type
type dynamics_type
   type(grid_type)     :: grid
   type(spectral_type) :: spec
   type(tendency_type) :: tend
   type(testing_type)  :: testing
...
allocate (Dyn%grid%ucurr		(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%uprev		(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%vcurr		(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%vprev		(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%vorcurr		(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%vorprev		(is:ie, js:je, num_time_levels))
...
allocate (Dyn%Grid%vormean_x		(is:ie, js:je, num_time_levels))
allocate (Dyn%Grid%vormean_y		(is:ie, js:je, num_time_levels))
allocate (Dyn%Grid%vorprime_x		(is:ie, js:je, num_time_levels))
allocate (Dyn%Grid%vorprime_y		(is:ie, js:je, num_time_levels))
allocate (Dyn%Grid%vormean_y_tend	(is:ie, js:je, num_time_levels))
allocate (Dyn%Grid%vor_y		(is:ie, js:je, num_time_levels))
allocate (Dyn%Grid%vor_x		(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%vorprime_prev	(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%vorprime_curr	(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%vorprime		(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%vork			(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%vork_prev		(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%vork_curr		(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%vortendk		(is:ie, js:je, num_time_levels))
allocate (Dyn%Grid%vormeantend		(is:ie, js:je, num_time_levels))
allocate (Dyn%Grid%vorprimetend		(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%enstrophy_rvormean_adevc_Matlab(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%enstrophy_rvorprime_adevc_Matlab(is:ie, js:je, num_time_levels))
allocate (Dyn%Grid%tester		(is:ie, js:je, num_time_levels))
allocate (Dyn%Grid%XX			(is:ie, js:je, num_time_levels))
...
allocate (Dyn%grid%enstrophy_tendk		(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%enstrophy_pvor_adveck	(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%enstrophy_rvormean_adveck	(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%enstrophy_trunck		(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%enstrophy_lindamp_ek		(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%enstrophy_lindamp_mk		(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%enstrophy_specdampk		(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%enstrophy_robdampk		(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%enstrophy_stirk		(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%enstrophy_rvorprime_adveck_SUM(is:ie, js:je, num_time_levels))
...
! Flux Terms
allocate (Dyn%grid%I_p01_q01(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p02_q01(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p03_q01(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p04_q01(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p05_q01(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p06_q01(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p07_q01(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p08_q01(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p09_q01(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p10_q01(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p11_q01(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p12_q01(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p01_q02(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p02_q02(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p03_q02(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p04_q02(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p05_q02(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p06_q02(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p07_q02(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p08_q02(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p09_q02(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p10_q02(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p11_q02(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p12_q02(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p01_q03(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p02_q03(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p03_q03(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p04_q03(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p05_q03(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p06_q03(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p07_q03(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p08_q03(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p09_q03(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p10_q03(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p11_q03(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p12_q03(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p01_q04(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p02_q04(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p03_q04(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p04_q04(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p05_q04(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p06_q04(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p07_q04(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p08_q04(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p09_q04(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p10_q04(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p11_q04(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p12_q04(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p01_q05(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p02_q05(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p03_q05(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p04_q05(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p05_q05(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p06_q05(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p07_q05(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p08_q05(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p09_q05(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p10_q05(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p11_q05(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p12_q05(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p01_q06(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p02_q06(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p03_q06(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p04_q06(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p05_q06(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p06_q06(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p07_q06(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p08_q06(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p09_q06(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p10_q06(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p11_q06(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p12_q06(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p01_q07(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p02_q07(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p03_q07(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p04_q07(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p05_q07(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p06_q07(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p07_q07(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p08_q07(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p09_q07(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p10_q07(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p11_q07(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p12_q07(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p01_q08(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p02_q08(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p03_q08(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p04_q08(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p05_q08(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p06_q08(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p07_q08(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p08_q08(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p09_q08(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p10_q08(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p11_q08(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p12_q08(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p01_q09(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p02_q09(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p03_q09(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p04_q09(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p05_q09(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p06_q09(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p07_q09(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p08_q09(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p09_q09(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p10_q09(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p11_q09(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p12_q09(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p01_q10(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p02_q10(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p03_q10(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p04_q10(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p05_q10(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p06_q10(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p07_q10(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p08_q10(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p09_q10(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p10_q10(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p11_q10(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p12_q10(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p01_q11(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p02_q11(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p03_q11(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p04_q11(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p05_q11(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p06_q11(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p07_q11(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p08_q11(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p09_q11(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p10_q11(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p11_q11(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p12_q11(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p01_q12(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p02_q12(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p03_q12(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p04_q12(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p05_q12(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p06_q12(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p07_q12(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p08_q12(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p09_q12(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p10_q12(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p11_q12(is:ie, js:je, num_time_levels))
allocate (Dyn%grid%I_p12_q12(is:ie, js:je, num_time_levels))
...
real,    dimension(is:ie, js:je)  :: enstrophytendcheck, vortendmean, pvor_advecmean, rvor_advecmean, vortruncmean, vorlindamp_emean, vorlindamp_mmean, vorspecdampmean, vorstirmean, vorrobdampmean, &
				     ...
				     enstrophytrunc_mean, enstrophytrunc_prime, enstrophystir_mean, enstrophystir_prime, vorprimetend, rvor_advec2
...
complex, dimension(is:ie+1, js:je):: uk, vk, vork, vork_curr, vork_prev, vorprimetendk, vorprimek, vorprimek_curr, vorprimek_prev, pvor_adveck, rvormean_adveck, enstrophy_pvor_adveck, & 
				     enstrophy_rvormean_adveck, vorprime_xk, vorprime_yk
...
complex, dimension(is:ie, is:ie, is:ie, js:je) :: enstrophy_rvorprime_adveck
integer, dimension(is:ie) :: kmat
...
integer :: p, q, k
 ...
 character(1024) :: I_p01_q01


!blah(1) = Dyn%grid%I_p01_q01
!blah(2) = Dyn%grid%I_p02_q01
!blah(3) = Dyn%grid%I_p03_q01
!blah(1)
...
do j = js, je
 ...
 vormean_prev(:,j)= sum(Dyn%Grid%vor(:,j,previous))/count(Dyn%Grid%u(:,j,previous) > -10000)
end do
vorprime_prev = Dyn%Grid%vor(:,:,previous)-vormean_prev(:,:)
enstrophyprev = vorprime_prev*vorprime_prev
vork_prev(1:ie/2+1,:) = fft_grid_to_fourier(Dyn%grid%vor(:,:,previous))
vork_prev(ie/2+2:ie+1,:) = conjg(vork_prev(ie/2+1:2:-1,:))
! CURRENT
do j = js, je
  umean_curr(:,j)= sum(Dyn%Grid%u(:,j,current))/count(Dyn%Grid%u(:,j,current) > -10000) ! Calculate zonal mean, zonal flow (needed for linear damping)
  vmean_curr(:,j)= sum(Dyn%Grid%v(:,j,current))/count(Dyn%Grid%v(:,j,future) > -10000)
  vormean_curr(:,j)= sum(Dyn%Grid%vor(:,j,current))/count(Dyn%Grid%u(:,j,current) > -10000) ! Calculate zonal mean, vorticity (needed for calculating beta_star)
  pvmean_curr(:,j)= sum(Dyn%Grid%vor(:,j,current))/count(Dyn%Grid%u(:,j,current) > -10000) + coriolis(j) ! Calculate zonal mean, pv (needed for calculating beta_star)
end do
vprime_curr = Dyn%Grid%v(:,:,current)-vmean_curr(:,:)
vorprime_prev = Dyn%Grid%vor(:,:,previous)-vormean_prev(:,:)
vorprime_curr = Dyn%Grid%vor(:,:,current)-vormean_curr(:,:)

vork_prev(1:ie/2+1,:) = fft_grid_to_fourier(Dyn%grid%vor(:,:,previous))
vork_prev(ie/2+2:ie+1,:) = conjg(vork_prev(ie/2+1:2:-1,:))
vork_curr(1:ie/2+1,:) = fft_grid_to_fourier(Dyn%grid%vor(:,:,current))
...
Dyn%grid%vorprime_prev(:,:,future) = vorprime_prev
Dyn%grid%vorprime_curr(:,:,future) = vorprime_curr
! ====================== FFT along LATITUDE??? ==================
!call fft_end
...
Dyn%Grid%uprev(:,:,future) = Dyn%Grid%v(:,:,previous)
Dyn%Grid%ucurr(:,:,future) = Dyn%Grid%u(:,:,current)
Dyn%Grid%vprev(:,:,future) = Dyn%Grid%v(:,:,previous)
Dyn%Grid%vcurr(:,:,future) = Dyn%Grid%v(:,:,current)
Dyn%Grid%vorprev(:,:,future) = Dyn%Grid%vor(:,:,previous)
Dyn%Grid%vorcurr(:,:,future) = Dyn%Grid%vor(:,:,current)
...
!print *, "VORPRIME_CURR", vorprime_curr(22,47)
 ...
 call vor_div_from_uv_grid (vormean_curr*Dyn%Grid%v(:,:,current), -vormean_curr*Dyn%Grid%u(:,:,current), dt_vors_rub, dt_divs_rub)  
...
! ZETA_PRIME
 call vor_div_from_uv_grid (vorprime_curr*Dyn%Grid%v(:,:,current), -vorprime_curr*Dyn%Grid%u(:,:,current), dt_vors_rub, dt_divs_rub) 
...
!print *, "RVOR_ADVEC", Dyn%grid%rvor_advec(22,47,future)
!print *, "TOTAL", Dyn%grid%rvormean_advec(22,47,future) + Dyn%grid%rvorprime_advec(22,47,future)
...
! ZETA_BAR_X
 ...
 call trans_spherical_to_grid(dt_vors_rub, Dyn%Grid%vormean_x(:,:,future))
! ZETA_BAR_Y
...
! ZETA_PRIME_X
 ...
 call trans_spherical_to_grid(dt_vors_rub, Dyn%Grid%vorprime_x(:,:,future))
! ZETA_PRIME_Y
 call vor_div_from_uv_grid (-vorprime_curr, zerog, dt_vors_rub, dt_divs_rub) 
 call trans_spherical_to_grid(dt_vors_rub, Dyn%Grid%vorprime_y(:,:,future))
...
!print *, "BETA_STAR",  Dyn%grid%beta_star(22,47,future)
 call vor_div_from_uv_grid (-Dyn%grid%vor(:,:,future), zerog, dt_vors_rub, dt_divs_rub) 
 call trans_spherical_to_grid(dt_vors_rub, Dyn%Grid%vor_y(:,:,future))
 call vor_div_from_uv_grid (zerog,Dyn%grid%vor(:,:,future), dt_vors_rub, dt_divs_rub) 
 call trans_spherical_to_grid(dt_vors_rub, Dyn%Grid%vor_x(:,:,future))
...
if(damp > 1) then ! do linear damping
 ...
 Dyn%Grid%ulindamp_e(:,:,future) = (Dyn%Grid%u(:,:,current)-umean_curr)/tau
 Dyn%Grid%ulindamp_m(:,:,future) = umean_curr/tau1
...
do j = js, je 
 umean(:,j)= sum(Dyn%Grid%u(:,j,future))/count(Dyn%Grid%u(:,j,future) > -10000) 
 vmean(:,j)= sum(Dyn%Grid%v(:,j,future))/count(Dyn%Grid%v(:,j,future) > -10000)
 ...
 vprime = Dyn%Grid%v(:,:,future)-vmean(:,:)
...
Dyn%Grid%energy_mean(:,:,future) = (umean**2+vmean**2)
...
Dyn%Grid%vormeantend(:,:,future) = (vormean-vormean_curr)/delta_t
Dyn%Grid%vorprimetend(:,:,future) = (vorprime-vorprime_curr)/delta_t
...
Dyn%Grid%vormeantend(:,:,future) = (vormean-vormean_prev)/delta_t
Dyn%Grid%vorprimetend(:,:,future) = (vorprime-vorprime_prev)/delta_t
...
!print *, "HELLO", Dyn%Grid%vortend(22,47,future) - (Dyn%Grid%vormeantend(22,47,future) + Dyn%Grid%vorprimetend(22,47,future))
!print *, "VOTMEAN TEND", Dyn%Grid%vormeantend(22,47,future)
!print *, "VORPRIME TEND", Dyn%Grid%vorprimetend(22,47,future)
! -------------------------------- ENERGY BUDGET TERMS --------------------------------------------
...
Dyn%Grid%energy_tend_mean(:,:,future) = utendmean(:,:)*(umean_prev(:,:)+umean(:,:)) + vtendmean(:,:)*(vmean_prev(:,:)+vmean(:,:))
!print *, "ENERGYTEND_MEAN", Dyn%Grid%energy_tend_mean(1,10,future)
!print *, "ENERGYTENDCHECK_MEAN", energytendcheck_mean(1,10)
Dyn%Grid%energy_voradvec_mean(:,:,future) = vqmean(:,:)*(umean_prev(:,:)+umean(:,:)) - uqmean(:,:)*(vmean_prev(:,:)+vmean(:,:))
!print *, "ENERGYVORADVEC_MEAN", Dyn%Grid%energy_voradvec_mean(1,10,future)
Dyn%Grid%energy_gradterm_mean(:,:,future) = dx_u2_v2mean(:,:)*(umean_prev(:,:)+umean(:,:)) + dy_u2_v2mean(:,:)*(vmean_prev(:,:)+vmean(:,:))
!print *, "ENERGYGRADTERM_MEAN", Dyn%Grid%energy_gradterm_mean(1,10,future)
Dyn%Grid%energy_trunc_mean(:,:,future) = utruncmean(:,:)*(umean_prev(:,:)+umean(:,:)) + vtruncmean(:,:)*(vmean_prev(:,:)+vmean(:,:))
!print *, "ENERGYTRUNC_MEAN", Dyn%Grid%energy_trunc_mean(1,10,future)
Dyn%Grid%energy_lindamp_m_mean(:,:,future) = ulindamp_mmean(:,:)*(umean_prev(:,:)+umean(:,:))
!print *, "ENERGYLINDAMP_M_MEAN", Dyn%Grid%energy_lindamp_m_mean(1,10,future)
Dyn%Grid%energy_lindamp_e_mean(:,:,future) = ulindamp_emean(:,:)*(umean_prev(:,:)+umean(:,:)) + vlindampmean(:,:)*(vmean_prev(:,:)+vmean(:,:))
!print *, "ENERGYLINDAMP_E_MEAN", Dyn%Grid%energy_lindamp_e_mean(1,10,future)
Dyn%Grid%energy_specdamp_mean(:,:,future) = uspecdampmean(:,:)*(umean_prev(:,:)+umean(:,:)) + vspecdampmean(:,:)*(vmean_prev(:,:)+vmean(:,:))
!print *, "ENERGYSPECDAMP_MEAN", Dyn%Grid%energy_specdamp_mean(1,10,future)
Dyn%Grid%energy_stir_mean(:,:,future) = ustirmean(:,:)*(umean_prev(:,:)+umean(:,:)) + vstirmean(:,:)*(vmean_prev(:,:)+vmean(:,:))
!print *, "ENERGYSTIR_MEAN", Dyn%Grid%energy_stir_mean(1,10,future)
Dyn%Grid%energy_robdamp_mean(:,:,future) = urobdampmean(:,:)*(umean_prev(:,:)+umean(:,:)) + vrobdampmean(:,:)*(vmean_prev(:,:)+vmean(:,:))
...
Dyn%Grid%enstrophy_tend(:,:,future) = 0.5*Dyn%grid%vorprimetend(:,:,future)*(vorprime_prev+vorprime)
...
Dyn%Grid%enstrophy_dt_vor(:,:,future) = Dyn%Grid%dt_vor(:,:,future)*vorprime_curr
!print *, "ENSTROPHY_DTVOR", Dyn%Grid%enstrophy_dt_vor(22,47,future)
Dyn%Grid%enstrophy_pvor_advec(:,:,future) = Dyn%Grid%pvor_advec(:,:,future)*vorprime_curr
!print *, "ENSTROPHY_PVORADVEC", Dyn%Grid%enstrophy_pvor_advec(22,47,future)
Dyn%Grid%enstrophy_rvormean_advec(:,:,future) = Dyn%Grid%rvormean_advec(:,:,future)*vorprime_curr
!print *, "ENSTROPHY_RVORMEAN_ADVEC", Dyn%Grid%enstrophy_rvormean_advec(22,47,future)
Dyn%Grid%enstrophy_rvorprime_advec(:,:,future) = Dyn%Grid%rvorprime_advec(:,:,future)*vorprime_curr
!print *, "ENSTROPHY_RVORPRIME_ADVEC", Dyn%Grid%enstrophy_rvorprime_advec(22,47,future)
Dyn%Grid%enstrophy_trunc(:,:,future) = Dyn%Grid%vortrunc(:,:,future)*vorprime_curr
!print *, "ENSTROPHY_TRUNC", Dyn%Grid%enstrophy_trunc(22,47,future)
Dyn%Grid%enstrophy_lindamp_m(:,:,future) = Dyn%Grid%vorlindamp_m(:,:,future)*vorprime_curr
!print *, "ENSTROPHY_LINDAMP_M", Dyn%Grid%enstrophy_lindamp_m(22,47,future)
Dyn%Grid%enstrophy_lindamp_e(:,:,future) = Dyn%Grid%vorlindamp_e(:,:,future)*vorprime_curr
!print *, "ENSTROPHY_LINDAMP_E", Dyn%Grid%enstrophy_lindamp_e(22,47,future)
Dyn%Grid%enstrophy_specdamp(:,:,future) = Dyn%Grid%vorspecdamp(:,:,future)*vorprime_curr
!print *, "ENSTROPHY_SPECDAMP", Dyn%Grid%enstrophy_specdamp(22,47,future)
Dyn%Grid%enstrophy_stir(:,:,future) = Dyn%Grid%vorstir(:,:,future)*vorprime_curr
!print *, "ENSTROPHY_STIR", Dyn%Grid%enstrophy_stir(22,47,future)
Dyn%Grid%enstrophy_robdamp(:,:,future) = Dyn%Grid%vorrobdamp(:,:,future)*vorprime_curr
!print *, "ENSTROPHY_ROBDAMP", Dyn%Grid%enstrophy_robdamp(22,47,future)

Dyn%grid%enstrophy_rvormean_adevc_Matlab(:,:,future) = (Dyn%Grid%u(:,:,current)*Dyn%grid%vormean_x(:,:,future) + Dyn%Grid%v(:,:,current)*Dyn%grid%vormean_y(:,:,future))*vorprime_curr
Dyn%grid%enstrophy_rvorprime_adevc_Matlab(:,:,future) = (Dyn%Grid%u(:,:,current)*Dyn%grid%vorprime_x(:,:,future) + Dyn%Grid%v(:,:,current)*Dyn%grid%vorprime_y(:,:,future))*vorprime_curr
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
do j = js, je 
 enstrophytrunc_mean(:,j)= sum(Dyn%Grid%enstrophy_trunc(:,j,future))/count(Dyn%Grid%u(:,j,future) > -10000)
 enstrophystir_mean(:,j)= sum(Dyn%Grid%enstrophy_stir(:,j,future))/count(Dyn%Grid%u(:,j,future) > -10000)
end do
enstrophytrunc_prime = Dyn%Grid%enstrophy_trunc(:,:,future)-enstrophytrunc_mean(:,:)
enstrophystir_prime = Dyn%Grid%enstrophy_stir(:,:,future)-enstrophystir_mean(:,:)
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
uk(1:ie/2,:) = fft_grid_to_fourier(Dyn%grid%u(:,:,future))
uk(ie/2+1:ie,:) = conjg(uk(ie/2+1:2:-1,:))
vk(1:ie/2,:) = fft_grid_to_fourier(Dyn%grid%v(:,:,future))
vk(ie/2+1:ie,:) = conjg(vk(ie/2+1:2:-1,:))
!vbetak(1:ie/2,:) = fft_grid_to_fourier(Dyn%Grid%v(:,:,future)*Dyn%grid%beta(:,:,future));
!vbetak(ie/2+1:ie,:) = conjg(vbetak(ie/2+1:2:-1,:))
pvor_adveck(1:ie/2,:) = fft_grid_to_fourier(Dyn%Grid%pvor_advec(:,:,future));
pvor_adveck(ie/2+1:ie,:) = conjg(pvor_adveck(ie/2+1:2:-1,:))
rvormean_adveck(1:ie/2,:) = fft_grid_to_fourier(Dyn%Grid%rvormean_advec(:,:,future));
rvormean_adveck(ie/2+1:ie,:) = conjg(rvormean_adveck(ie/2+1:2:-1,:))
vorprime_xk(1:ie/2,:) = fft_grid_to_fourier(Dyn%grid%vorprime_x(:,:,future))
vorprime_xk(ie/2+1:ie,:) = conjg(vorprime_xk(ie/2+1:2:-1,:))
vorprime_yk(1:ie/2,:) = fft_grid_to_fourier(Dyn%grid%vorprime_y(:,:,future))
vorprime_yk(ie/2+1:ie,:) = conjg(vorprime_yk(ie/2+1:2:-1,:))
vorprimetendk(1:ie/2,:) = fft_grid_to_fourier(Dyn%Grid%vorprimetend(:,:,future))
vorprimetendk(ie/2+1:ie,:) = conjg(vorprimetendk(ie/2+1:2:-1,:))

vdy_vormeank(1:ie/2,:) = fft_grid_to_fourier(Dyn%Grid%v(:,:,future)*Dyn%grid%vormean_y(:,:,future));
vdy_vormeank(ie/2+1:ie,:) = conjg(vdy_vormeank(ie/2+1:2:-1,:))
vortrunck(1:ie/2,:) = fft_grid_to_fourier(Dyn%grid%vortrunc(:,:,future))
vortrunck(ie/2+1:ie,:) = conjg(vortrunck(ie/2+1:2:-1,:))
!print *, "VORTRUNCK", vortrunck(6,47)
vorlindamp_ek(1:ie/2,:) = fft_grid_to_fourier(Dyn%grid%vorlindamp_e(:,:,future))
vorlindamp_ek(ie/2+1:ie,:) = conjg(vorlindamp_ek(ie/2+1:2:-1,:))
vorlindamp_mk(1:ie/2,:) = fft_grid_to_fourier(Dyn%grid%vorlindamp_m(:,:,future))
vorlindamp_mk(ie/2+1:ie,:) = conjg(vorlindamp_mk(ie/2+1:2:-1,:))
vorrobdampk(1:ie/2,:) = fft_grid_to_fourier(Dyn%grid%vorrobdamp(:,:,future))
vorrobdampk(ie/2+1:ie,:) = conjg(vorrobdampk(ie/2+1:2:-1,:))
vorspecdampk(1:ie/2,:) = fft_grid_to_fourier(Dyn%grid%vorspecdamp(:,:,future))
vorspecdampk(ie/2+1:ie,:) = conjg(vorspecdampk(ie/2+1:2:-1,:))
vorstirk(1:ie/2,:) = fft_grid_to_fourier(Dyn%grid%vorstir(:,:,future))
...
Dyn%grid%vork(1:ie/2+1,:,future) = real(vork(1:ie/2+1,:)) ! First n/2+1 positions belong to real values
Dyn%grid%vork(ie/2+2:ie,:,future)= aimag(vork(2:ie/2,:)) ! last n/2-1 positions belong to imaginary values.

Dyn%grid%vork_curr(1:ie/2+1,:,future) = real(vork_curr(1:ie/2+1,:)) ! First n/2+1 positions belong to real values
Dyn%grid%vork_curr(ie/2+2:ie,:,future)= aimag(vork_curr(2:ie/2,:)) ! last n/2-1 positions belong to imaginary values.

Dyn%grid%vork_prev(1:ie/2+1,:,future) = real(vork_prev(1:ie/2+1,:)) ! First n/2+1 positions belong to real values
Dyn%grid%vork_prev(ie/2+2:ie,:,future)= aimag(vork_prev(2:ie/2,:)) ! last n/2-1 positions belong to imaginary values.
...
Dyn%grid%vortendk(1:ie/2+1,:,future) = real(vorprimetendk(1:ie/2+1,:))
Dyn%grid%vortendk(ie/2+2:ie,:,future)= aimag(vorprimetendk(2:ie/2,:))
Dyn%grid%enstrophy_tendk(1:ie/2+1,:,future) = real(enstrophy_tendk(1:ie/2+1,:))
Dyn%grid%enstrophy_tendk(ie/2+2:ie,:,future)= aimag(enstrophy_tendk(2:ie/2,:))
Dyn%grid%enstrophy_pvor_adveck(1:ie/2+1,:,future) = real(enstrophy_pvor_adveck(1:ie/2+1,:))
Dyn%grid%enstrophy_pvor_adveck(ie/2+2:ie,:,future)= aimag(enstrophy_pvor_adveck(2:ie/2,:))
Dyn%grid%enstrophy_rvormean_adveck(1:ie/2+1,:,future) = real(enstrophy_rvormean_adveck(1:ie/2+1,:))
Dyn%grid%enstrophy_rvormean_adveck(ie/2+2:ie,:,future)= aimag(enstrophy_rvormean_adveck(2:ie/2,:))
Dyn%grid%enstrophy_trunck(1:ie/2+1,:,future) = real(enstrophy_trunck(1:ie/2+1,:))
Dyn%grid%enstrophy_trunck(ie/2+2:ie,:,future)= aimag(enstrophy_trunck(2:ie/2,:))
Dyn%grid%enstrophy_lindamp_ek(1:ie/2+1,:,future) = real(enstrophy_lindamp_ek(1:ie/2+1,:))
Dyn%grid%enstrophy_lindamp_ek(ie/2+2:ie,:,future)= aimag(enstrophy_lindamp_ek(2:ie/2,:))
Dyn%grid%enstrophy_lindamp_mk(1:ie/2+1,:,future) = real(enstrophy_lindamp_mk(1:ie/2+1,:))
Dyn%grid%enstrophy_lindamp_mk(ie/2+2:ie,:,future)= aimag(enstrophy_lindamp_mk(2:ie/2,:))
Dyn%grid%enstrophy_specdampk(1:ie/2+1,:,future) = real(enstrophy_specdampk(1:ie/2+1,:))
Dyn%grid%enstrophy_specdampk(ie/2+2:ie,:,future)= aimag(enstrophy_specdampk(2:ie/2,:))
Dyn%grid%enstrophy_robdampk(1:ie/2+1,:,future) = real(enstrophy_robdampk(1:ie/2+1,:))
Dyn%grid%enstrophy_robdampk(ie/2+2:ie,:,future)= aimag(enstrophy_robdampk(2:ie/2,:))
Dyn%grid%enstrophy_stirk(1:ie/2+1,:,future) = real(enstrophy_stirk(1:ie/2+1,:))
Dyn%grid%enstrophy_stirk(ie/2+2:ie,:,future)= aimag(enstrophy_stirk(2:ie/2,:))
...
!print *, size(sum(sum(enstrophy_rvorprime_adveck,1),1),1), size(sum(sum(enstrophy_rvorprime_adveck,1),1),2)

Dyn%grid%enstrophy_rvorprime_adveck_SUM(1:ie/2+1,:,future) = ie**2*real(sum(sum(enstrophy_rvorprime_adveck(:,:,1:ie/2+1,:),1),1))
Dyn%grid%enstrophy_rvorprime_adveck_SUM(ie/2+2:ie,:,future)= ie**2*aimag(sum(sum(enstrophy_rvorprime_adveck(:,:,2:ie/2,:),1),1))

!do p=1,12!size(kmat)/2
!       do q=1,12!size(kmat)/2
!	    write(filename, "(A12,I0.3,A2,I0.3)") "Dyn%grid%I_p", p, "_q", q
!	    print *, trim(filename)//"(1:ie/2+1,:,future) = ie**2*real(enstrophy_rvorprime_adveck(",p ,","!, q,",", "1:ie/2+1,:))"
!	    filename(1:ie/2+1,:,future) = ie**2*real(enstrophy_rvorprime_adveck(p,q,1:ie/2+1,:))
!	    filename(ie/2+2:ie,:,future) = ie**2*aimag(enstrophy_rvorprime_adveck(p,q,2:ie/2,:))
!       end do
!end do
...
!print *, "BUDGET: VORTEND = DT_VOR - VORTRUNC - LIND + SPECD + STIR + ROBD", Dyn%Grid%vortend(22,47,future) - (Dyn%Grid%dt_vor(22,47,future) - Dyn%grid%vortrunc(22,47,future) - & 
!Dyn%grid%vorlindamp_e(22,47,future) - Dyn%grid%vorlindamp_m(22,47,future) + Dyn%Grid%vorspecdamp(22,47,future) + Dyn%Grid%vorstir(22,47,future) + Dyn%Grid%vorrobdamp(22,47,future))
!print *, "BUDGET: VORTEND = PVOR_ADV + RVOR_ADV - VORTRUNC - LIND + SPECD + STIR + ROBD", Dyn%Grid%vortend(22,47,future) - (Dyn%Grid%pvor_advec(22,47,future) + Dyn%Grid%rvormean_advec(22,47,future) + &
...
if(file_exist('INPUT/barotropic_dynamics.res.nc')) then
  do nt = 1, 2
    ...
    call read_data('INPUT/barotropic_dynamics.res.nc', 'vormean_y_tend', Dyn%Grid%vormean_y_tend(:,:,nt), grid_domain, timelevel=nt)
    if(Dyn%spec_tracer) then
...
do nt = 1, 2
  ...
  call write_data('RESTART/barotropic_dynamics.res.nc', 'vormean_y_tend', Dyn%Grid%vormean_y_tend(:,:,nn), grid_domain)

!  call write_data('RESTART/enstrophy_rvorprime_adveck_SUM.res.nc', 'enstrophy_rvorprime_adveck_SUM', Dyn%grid%enstrophy_rvorprime_adveck_SUM(:,:,nn), grid_domain)
!   call write_data('RESTART/enstrophy_rvorprime_adveck_SUM2.nc', 'enstrophy_rvorprime_adveck_SUM2', Dyn%grid%enstrophy_rvorprime_adveck_SUM(:,:,nn), grid_domain)
