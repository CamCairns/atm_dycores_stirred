...
real,    dimension(is:ie, js:je)  :: dt_vorg, stir, umean_current, vmean_current, uprime, beta, vormean, vorprime, energyprev, energymean_prev
...
! Need these for the product rule (see documentation)
do j = js, je 
