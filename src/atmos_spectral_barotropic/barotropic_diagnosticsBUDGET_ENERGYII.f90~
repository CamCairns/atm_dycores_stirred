...
integer :: id_vor, id_stream, id_pv, id_u, id_v, id_utend, id_vtend, id_vortend, id_utrunc, id_vtrunc, id_vortrunc, id_ulindamp_m, id_ulindamp_e, id_vlindamp, id_vorlindamp_m, id_vorlindamp_e, id_ustir, id_vstir, id_vorstir, id_uspecdamp, id_vspecdamp, id_vorspecdamp, id_urobdamp, id_vrobdamp, id_vq, id_uq, id_dt_vor, id_vorrobdamp, id_trs, id_tr, id_dx_u2_v2, id_dy_u2_v2
integer :: id_energy, id_energy_tend, id_energy_voradvec, id_energy_gradterm, id_energy_trunc, id_energy_lindamp_m, id_energy_lindamp_e, id_energy_specdamp, id_energy_stir, id_energy_robdamp, id_energy_mean, id_energy_tend_mean, id_energy_voradvec_mean, id_energy_gradterm_mean, id_energy_trunc_mean, id_energy_lindamp_m_mean, id_energy_lindamp_e_mean, id_energy_specdamp_mean, id_energy_stir_mean, id_energy_robdamp_mean
