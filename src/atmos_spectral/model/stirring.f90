...
real ::  astir, bstir
integer :: num_steps, num_fourier, num_spherical, nseed, lowk, highk,lowtot, hightot
...
namelist / stirring_nml / decay_time, amplitude, lat0, lon0, widthy, widthx, B, lowk, highk, lowtot, hightot
