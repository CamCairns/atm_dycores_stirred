...
integer :: id_udt_damp, id_udt_in, id_udt_sigma, id_udt_pgrad, id_udt_vertadvec,id_wtheta, id_udt_vorflux, id_udt_vorfluxm, id_udt_vorfluxf, id_udt_out, id_udt_int, id_udt_timestep, id_udt_trunc, id_vdt_damp, id_vdt_in, id_vdt_sigma, id_vdt_pgrad, id_vdt_vertadvec, id_vdt_vorflux, id_vdt_out, id_vdt_int, id_vdt_timestep, id_vdt_trunc, id_tdt_damp, id_vorg_post,  id_divg_post, id_vtheta, id_eke
...
id_wtheta =  register_diag_field(mod_name, 'wtheta',  axes_3d, Time, 'Zonal wind tend from horiz diff',      'm/s**2')
...
real, intent(in), dimension(is:ie, js:je, num_levels)             :: dt_ug_in, dt_ug_sigma, dt_ug_pgrad, dt_ug_vertadvec, wtheta, dt_ug_vorflux, dt_ug_vorfluxm, dt_ug_vorfluxf, dt_ug_out, dt_ug_int, dt_ug_timestep, dt_ug_trunc, vtheta, eke
...
if(id_wtheta > 0) then
  used = send_data(id_wtheta, wtheta, Time)
endif
