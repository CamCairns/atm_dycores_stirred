...
integer, parameter  :: max_fields_per_file = 750 !150
...
integer, parameter  :: VERY_LARGE_FILE_FREQ = 20000
integer, parameter  :: VERY_LARGE_AXIS_LENGTH = 20000
...
integer             :: num_files = 0
integer             :: max_input_fields = 750 !300
integer             :: num_input_fields = 0
integer             :: max_output_fields = 750 !300
...
character(len=128),private  :: tagname = '$Name: latest $'
